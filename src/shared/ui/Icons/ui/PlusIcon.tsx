  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 4.125C12.4832 4.125 12.875 4.51675 12.875 5V19C12.875 19.4832 12.4832 19.875 12 19.875C11.5168 19.875 11.125 19.4832 11.125 19V5C11.125 4.51675 11.5168 4.125 12 4.125Z"
        fill="#181D25"
      />
      <path
        fillRule="evenodd"
